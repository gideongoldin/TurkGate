...
<html>
	...
	if (isset($_POST['submit'])) {
		...
		// Validate entries
		if (empty($database_host) || empty($database_name) || empty($database_username) || empty($database_password)) {
			// For HTMLn where n < 5
		...
		?>";
			...
			// Select the database
			mysql_select_db($database_name, $connection) or die("<h1>TurkGate</h1><h2>Installation</h2><p>Error selecting database: " . mysql_error() . "</p><p><a href='javascript:history.back()'>Go back</a></p>" . $footer);
...
?>
	...
	<body>
		...
		<p>
			A new database called "TurkGate" will be created automatically.
		</p>
		...
		<form method="post" action="install.php">
			...
			<p>
				...
				<input type="text" name="database_name" required="required" autofocus="autofocus">
				<i>(E.g., 'TurkGate')</i>
			</p>
