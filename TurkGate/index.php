...
<?php require_once('includes/header.php'); ?>
	...
	<div class="container"> <!-- Container -->
		...
		<header>
			<h1 class="remove-bottom" style="margin-top: 40px; padding-bottom: 10px;">TurkGate</h1>
		</header>
		</div>		
			...
			<div class="sixteen columns clearfix" style="border-top: 1px solid #DDD; padding-top:10px;"> <!-- sixteen columns clearfix -->
				...
				<div class="six columns alpha">
					...
					<p>
						<label for="externalSurveyURL">*External Survey URL:</label> <input type="text" name="externalSurveyURL" value='<?php echo "$externalSurvey"; ?>' size="40" placeholder="http://surveysite.com/surveyid" autofocus="" required="">
					</p>
					<p>
