...
<body>
	...
	<h2>Automatic Code Verification</h2>
	
	<?php
	
		$salt = 'npeppa'; // Replace this with your own private salt!
...
<?php foreach ($csv->data as $key => $row):
        ...
        ?>
            <h3>Copy and paste the contents of your results file into the textbox below:</h3>
            <form method="post" action="verifyCompletionCode.php">
                <textarea name="results" rows="20" cols="100" wrap="off"></textarea>
                <br />
                <input type="submit" value="Analyze Results" name="submit">
            </form>
            <?php
        }
    ?>
